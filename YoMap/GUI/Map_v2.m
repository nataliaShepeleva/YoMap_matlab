...
switch categoryA
    ...
    case 3
        set(handles.poiMenuA,'Value', 1);
        set(handles.poiMenuA,'String', poi2);
    case 4
        set(handles.poiMenuA,'Value', 1);
        set(handles.poiMenuA,'String', poi3);
    case 5
        set(handles.poiMenuA,'Value', 1);
        set(handles.poiMenuA,'String', poi4);
end
...
global poi4;
%contents = cellstr(get(hObject,'String'));
%categoryB = contents{get(hObject,'Value')};
...
switch categoryB
    ...
    case 2
        set(handles.poiMenuB,'Value', 1);
        set(handles.poiMenuB,'String', poi1);
    case 3
        set(handles.poiMenuB,'Value', 1);
        set(handles.poiMenuB,'String', poi2);
    case 4
        set(handles.poiMenuB,'Value', 1);
        set(handles.poiMenuB,'String', poi3);
    case 5
        set(handles.poiMenuB,'Value', 1);
        set(handles.poiMenuB,'String', poi4);
end
